# 🍕 Pizza39 — Full-Stack Web App

**Pizza39** — це вебзастосунок для онлайн-замовлення піци.  
Проєкт побудовано на **React (frontend)** та **ASP.NET Core (backend)** із **PostgreSQL** як базою даних.
